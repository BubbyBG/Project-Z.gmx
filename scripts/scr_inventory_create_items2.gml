///scr_inventory_create_items(id,x,ystart)
//OLD SYSYTEM: id,name,amount,price,type,stat1,stat2,description
//NEW SYSYTEM: 0 - name, 1 - amount, 2 - typeID#, 3 - itemID#
if instance_exists(obj_inventory_item) {with (obj_inventory_item) {instance_destroy();}}
...
for (i = 0; i < rows_todraw; i++)
    {
    j = instance_create(argument1,argument2+(12*i),obj_inventory_item)
    j.grid_id = argument0
